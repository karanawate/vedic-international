                          ...
                          <td><?php echo   $i++ ?></td>
                           <td>
                             <div class="d-flex align-items-center gap-3 cursor-pointer">
                                <img src="<?php echo 'http://localhost/app7/public/blogsImages/'.$blog['blog_file']; ?>" class="rounded-circle" width="44" height="44" alt="">
                                <div class="">
                                  <p class="mb-0"><?php echo $blog['title']; ?></p>
                                </div>
                             </div>
                           </td>
                           ...
                           <td>
                             <div class="table-actions d-flex align-items-center gap-3 fs-6">
                              ...
                              <a href ="<?php echo base_url("blog/delete/". $blog['blogId']); ?>" class="text-danger"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
