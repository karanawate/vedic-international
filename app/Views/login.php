              ...
              <div class="row g-0">
                ...
                <div class="col-lg-6">
                  <div class="card-body p-4 p-sm-5">
                    ...
                    <form class="form-body" action="<?php echo base_url('login-submit'); ?>" method="POST">
                      <div class="d-grid">
                      ...
                      <div class="login-separater text-center mb-4"> <span>OR SIGN IN WITH EMAIL</span>
                        <?php
                            if(isset($both_error)){ ?>
                                <span style="color"><?php echo  $both_error['error']; ?></span>
                            <?php }else{ ?>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            <div class="d-grid">
                              <button type="submit" name="submit" value="submit" class="btn btn-primary radius-30">Sign In</button>
                            </div>
                          </div>
                          <div class="col-12">
